    ...
    <body>
        ...
        <div>
          ...
          <form action="" method="POST">
            ...
            <input id="food" type="number" name="distance" placeholder="up to 3kms" ><br><br>
             
            <label for="pickup time">Pickup_time:</label>
            <input id="pickup time" type="time" name="pickup_time"><br><br>
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
            ...
            $con = mysqli_connect("localhost","root","","assignment");                      
			        ...
			        $query = "INSERT INTO `walking` (service, petname,petbreed, petage, startdate,enddate,distance,pickup_time,Emailid) VALUES ( '$service','$name', '$breed', '$age', '$start' ,'$end', '$dist', '$time','$user_email')";
